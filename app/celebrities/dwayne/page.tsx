...
const celebrity = {
  ...
  rating: 4.8,
  reviews_count: 187,
  bio: "Dwayne 'The Rock' Johnson is a former WWE Champion turned Hollywood superstar. One of the highest-paid actors in the world, known for the Fast & Furious franchise, Jumanji, Black Adam, and his electrifying personality both on and off screen.",
  image_url: "/celebs/dwane.avif",
  tags: ["Actor", "Producer", "Former WWE Champion"],
};
...
const reviews = [
  { id: "1", name: "Kevin M.", rating: 5, comment: "The Rock was everything you'd expect — massive presence, huge heart.", date: "March 2025", initial: "K" },
  { id: "2", name: "Diana L.", rating: 5, comment: "My son met his hero. Dwayne was patient and genuinely kind with the kids.", date: "February 2025", initial: "D" },
  ...
  return (
    <div className="bg-[var(--background)] min-h-screen">
      ...
      <section className="relative h-[60vh] min-h-[420px] flex items-end overflow-hidden">
        ...
        <motion.div className="relative z-10 w-full max-w-5xl mx-auto px-6 pb-10" initial="hidden" animate="visible" variants={stagger}>
          ...
          <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-4 text-sm">
            ...
            <span className="text-white/50">🎵 {celebrity.category}</span>
