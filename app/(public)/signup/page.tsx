    ...
    <div className="min-h-screen bg-[var(--background)] flex items-center justify-center px-6 py-20">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="text-center mb-8">
          ...
          <p className="text-[var(--accent)] text-sm mt-2">Create your account</p>
        </motion.div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Password */}
            <div>
              <label className="text-[var(--accent)] text-xs mb-2 block">Password</label>
              <input
                type="password"
                value={password}
            ...
            {/* Confirm Password */}
            <div>
              <label className="text-[var(--accent)] text-xs mb-2 block">Confirm password</label>
              <input
                type="password"
                value={confirm}
            ...
            {/* Terms */}
            <p className="text-[var(--accent)] text-xs text-center leading-relaxed">
              By creating an account you agree to our{" "}
              <Link href="/terms" className="text-[var(--foreground)] hover:underline">Terms</Link>
              {" "}and{" "}
              <Link href="/privacy" className="text-[var(--foreground)] hover:underline">Privacy Policy</Link>
            </p>
        ...
        <motion.p variants={fadeUp} className="text-center text-[var(--accent)] text-sm mt-6">
          ...
          <Link href="/signin" className="text-[var(--foreground)] font-semibold hover:underline">
            Sign in
          </Link>
        </motion.p>
