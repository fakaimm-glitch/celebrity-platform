...
const staticCelebrity = {
  name: "Dwayne Johnson",
  category: "Actor & Entrepreneur",
  country: "United States",
  price: 400000,
  rating: 4.8,
  reviews_count: 158,
  bio: "Dwayne 'The Rock' Johnson is one of Hollywood's highest-paid actors and a global entertainment icon. From professional wrestling to blockbuster films and business ventures, he has built an empire on charisma, discipline, and relentless work ethic.",
  image_url: "/celebs/dwane.avif",
  tags: ["Actor", "Entrepreneur", "Former WWE Champion"],
};
...
const reviews = [
  { id: "1", name: "James K.", rating: 5, comment: "The Rock was everything you'd expect — larger than life and genuinely humble. Incredible!", date: "March 2025", initial: "J" },
  { id: "2", name: "Priya M.", rating: 5, comment: "He spent real time with us, gave advice, and took photos. Absolutely worth it.", date: "February 2025", initial: "P" },
  { id: "3", name: "Tom W.", rating: 4, comment: "Motivating, energetic, and down to earth. A night I will never forget.", date: "January 2025", initial: "T" },
];
...
export default function DwayneJohnsonPage() {
  ...
  return (
    <DashboardShell title="Dwayne Johnson" subtitle="Actor & Entrepreneur">
